      ...
      <div className="section section-hero section-shaped">
        <div className="page-header">
          <div
            ...
            style={{
              backgroundImage:
                "url(" + require("assets/img/ill/mitch-portrait-color.png") + ")",
            }}
          ></div>
          <Container
            ...
            <div className="col px-0">
              <Row>
                <Col className="ml-5" lg="4">
                  ...
                  <p className="lead">
                    Helping professionals find peace<br></br>
                    <b>Entrepreneur. Executive Coach. Your Measured Friend</b>
                  </p>
                  <div className="btn-wrapper mt-5">
                    ...
                    >
                      ...
                      <span className="btn-inner--text">Book Mitch</span>
                    </Button>
                  </div>
                  <div className="mt-5">
