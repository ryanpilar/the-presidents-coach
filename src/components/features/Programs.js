...
function Programs({ icons, iconStyle, glow, resetGlow, isGlowing, changeGlow }) {
              ...
              {/* CARD ONE */}
                <Col lg="4">
                  <Card className="card-lift--hover shadow border-0 ">
                      ...
                      <div 
                        style={{
                          border: isGlowing.coachOne && `6px solid ${glow.coachOne.ribbonBorder}`,
                  ...
                  <Card className="card-lift--hover shadow border-0">
                    ...
                    >
                      ...
                      <div 
                        ...
                        style={{
                          // background: "red",
                          border: isGlowing.coachTwo && `6px solid ${glow.coachTwo.ribbonBorder}`,
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div 
                        ...
                        style={{
                          // background: "red",
                          border: isGlowing.coachThree && `6px solid ${glow.coachThree.ribbonBorder}`,
